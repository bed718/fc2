 ...
 */
function fc_admin_preprocess_maintenance_page(&$vars) {
  // While markup for normal pages is split into page.tpl.php and html.tpl.php,
  // the markup for the maintenance page is all in the single
  // maintenance-page.tpl.php template. So, to have what's done in
  // fc_admin_preprocess_html() also happen on the maintenance page, it has to be
  // called here.
  fc_admin_preprocess_html($vars);
}

/**
 * Override or insert variables into the html template.
 */
function fc_admin_preprocess_html(&$vars) {
 ...
 */
function fc_admin_preprocess_page(&$vars) {
 ...
 */
function fc_admin_node_add_list($variables) {
 ...
 */
function fc_admin_admin_block_content($variables) {
  $content = $variables['content'];
  $output = '';
  if (!empty($content)) {
 ...
 */
function fc_admin_tablesort_indicator($variables) {
 ...
 */
function fc_admin_css_alter(&$css) {
